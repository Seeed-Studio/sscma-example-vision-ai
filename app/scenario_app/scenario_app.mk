...
ifdef COMPONENT_SUPPORT_LIST	
	override COMPONENT_SUPPORT_LIST  := $(sort $(strip $(SCENARIO_APP_REQUIRED) $(COMPONENT_SUPPORT_LIST)))
	COMPONENT_SUPPORT_SORTED = $(sort $(COMPONENT_SUPPORT_LIST))		
	SCENARIO_APP_CSRCDIR += $(foreach SCENARIO_APP_CLI, $(COMPONENT_SUPPORT_SORTED), $(addprefix $(SCENARIO_APP_ROOT)/, $(SCENARIO_APP_CLI)))
	SCENARIO_APP_CCSRCDIR += $(foreach SCENARIO_APP_CLI, $(COMPONENT_SUPPORT_SORTED), $(addprefix $(SCENARIO_APP_ROOT)/, $(SCENARIO_APP_CLI)))
	SCENARIO_APP_CXXSRCDIR += $(foreach SCENARIO_APP_CLI, $(COMPONENT_SUPPORT_SORTED), $(addprefix $(SCENARIO_APP_ROOT)/, $(SCENARIO_APP_CLI)))
	SCENARIO_APP_INCDIR += $(foreach SCENARIO_APP_CLI, $(COMPONENT_SUPPORT_SORTED), $(addprefix $(SCENARIO_APP_ROOT)/, $(SCENARIO_APP_CLI)))
endif
