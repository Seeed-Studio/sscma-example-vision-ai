...
| ---- | -----| ---| ---| -----------| --------| --------| --------|
| Grove Vision AI |          Poninter Meter         | [custom](https://files.seeedstudio.com/wiki/Edgelab/meter.zip)|112x112 (RGB)| 320KB |     500ms    |  97% |[pfld_meter_int8.tflite](./model_zoo/pfld_meter_int8.tflite)|
