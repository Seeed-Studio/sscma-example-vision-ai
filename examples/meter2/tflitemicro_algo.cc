                ...
                float end_x, float end_y, float center_x, float center_y, float start_value, float end_value)
{
    ...
    */
    // LOGGER_INFO("x: %f, y: %f, start_x: %f, start_y: %f, end_x: %f, end_y: %f, center_x: %f, center_y: %f, start_value: %f, end_value: %f\n",
    //             x, y, start_x, start_y, end_x, end_y, center_x, center_y, start_value, end_value);
...
int tflitemicro_algo_get_preview(char *preview, uint16_t max_length)
{
    ...
    int32_t value = get_value(x, y, s_x, s_y, e_x, e_y, c_x, c_y, start_value, end_value) * 10000;
