...
namespace tflite
{
  ...
  {
    return tflite::micro::RegisterOp(tflite::ops::micro::pooling::Init, tflite::ops::micro::pooling::Prepare, tflite::ops::micro::pooling::AverageEval);
  }

  TfLiteRegistration_V1 Register_MAX_POOL_2D()
  {
    return tflite::micro::RegisterOp(tflite::ops::micro::pooling::Init, tflite::ops::micro::pooling::Prepare, tflite::ops::micro::pooling::MaxEval);
  }
