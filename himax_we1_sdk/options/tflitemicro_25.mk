...
$(LIB_CV_DIR)/tensorflow/lite/core/c/common.cc \
$(LIB_CV_DIR)/tensorflow/lite/kernels/internal/portable_tensor_utils.cc \
$(LIB_CV_DIR)/tensorflow/lite/kernels/internal/quantization_util.cc \
$(LIB_CV_DIR)/tensorflow/lite/kernels/internal/reference/portable_tensor_utils.cc \
$(LIB_CV_DIR)/tensorflow/lite/kernels/internal/tensor_utils.cc \
$(LIB_CV_DIR)/tensorflow/lite/kernels/kernel_util.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/all_ops_resolver.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/arena_allocator/non_persistent_arena_buffer_allocator.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/arena_allocator/persistent_arena_buffer_allocator.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/arena_allocator/recording_single_arena_buffer_allocator.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/arena_allocator/single_arena_buffer_allocator.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/debug_log.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/fake_micro_context.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/flatbuffer_utils.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/activations.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/activations_common.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/add.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/add_common.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/add_n.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/arg_min_max.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/assign_variable.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/batch_to_space_nd.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/broadcast_args.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/broadcast_to.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/call_once.cc \
...
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/circular_buffer_common.cc \
...
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/dequantize_common.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/detection_postprocess.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/div.cc \
...
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/hard_swish_common.cc \
...
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/leaky_relu_common.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/log_softmax.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/logical.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/logical_common.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/logistic.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/logistic_common.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/lstm_eval.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/lstm_eval_common.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/maximum_minimum.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/micro_tensor_utils.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/mirror_pad.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/mul.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/mul_common.cc \
...
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/pooling_common.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/prelu.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/prelu_common.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/quantize.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/quantize_common.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/read_variable.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/reduce.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/reduce_common.cc \
...
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/select.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/shape.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/slice.cc \
...
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/space_to_depth.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/split.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/split_v.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/squared_difference.cc \
...
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/sub_common.cc \
...
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/unidirectional_sequence_lstm.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/unpack.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/var_handle.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/kernels/while.cc \
...
$(LIB_CV_DIR)/tensorflow/lite/micro/memory_planner/non_persistent_buffer_planner_shim.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/micro_allocation_info.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/micro_allocator.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/micro_context.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/micro_graph.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/micro_interpreter.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/micro_log.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/micro_op_resolver.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/micro_profiler.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/micro_resource_variable.cc \
...
$(LIB_CV_DIR)/tensorflow/lite/micro/test_helper_custom_ops.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/test_helpers.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/tflite_bridge/flatbuffer_conversions_bridge.cc \
$(LIB_CV_DIR)/tensorflow/lite/micro/tflite_bridge/micro_error_reporter.cc \
...
APPL_DEFINES +=  -DNDEBUG -g -DTF_LITE_STATIC_MEMORY -DEMBARC_TCF_GENERATED -Os -ffunction-sections -fdata-sections -fno-rtti -fno-exceptions 
ifeq ($(TOOLCHAIN), mw)
