...
ifeq ($(OS_TYPE), )
	$(CP) ./himax_we1_sdk/library/libembarc_72pin_gnu.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/libembarc.a
ifeq ($(HW), grove_vision_ai)
	$(CP) ./himax_we1_sdk/library/libgrove_open_socket.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/libboard_open_socket.a
else ifeq ($(HW), sensecap_vision_ai)
	$(CP) ./himax_we1_sdk/library/libsensecap_open_socket.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/libboard_open_socket.a
endif
	$(CP) ./himax_we1_sdk/library/libbss.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/libbss.a
else
...
$(SECURE_LIB) :
ifeq "$(HOST_OS)" "Windows"
	$(CP) ./himax_we1_sdk/library/liblibsecurity_r16.a $(BOARD_OUT_DIR)\$(BUILD_INFO)\liblibsecurity.a
else
	$(CP) ./himax_we1_sdk/library/liblibsecurity_r16.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/liblibsecurity.a
endif
